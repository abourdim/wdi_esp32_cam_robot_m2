...
// just the sketch into an existing PlatformIO project. tools/bump_version.py
// updates this definition for each numbered release.
#define ROBOT_FIRMWARE_VERSION "v1.2"
